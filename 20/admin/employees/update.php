...
<body>
    <?php $id = $_GET['id'];
     ...
     $sql="select * from employees where id_empl = '$id'";
    ...
    <form action="update_process.php" method="POST">
        ...
        date of birth
        <input type="date" name="birth" value="<?php echo $result['date_of_birth'] ?>"><br>
        email
        <input type="text" name="email" value="<?php echo $result['email'] ?>"><br>
        password
        <input type="text" name="password" value="<?php echo $result['password'] ?>"><br>
        level
        <input type="number" name="level" value="<?php echo $result['level'] ?>">
